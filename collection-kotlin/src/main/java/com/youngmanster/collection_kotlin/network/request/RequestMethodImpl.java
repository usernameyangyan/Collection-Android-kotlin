package com.youngmanster.collection_kotlin.network.request;
...
import com.youngmanster.collection_kotlin.network.download.DownloadFileHelper;
...
import com.youngmanster.collection_kotlin.network.convert.ConvertParamUtils;
        ...
        return Observable.just(builder.getUrl())
                .flatMap(new Function<String, ObservableSource<DownloadInfo>>() {
                    ...
                    public Observable<ResponseBody> apply(DownloadInfo downInfo) {
                        return RetrofitManager.Companion.getApiService(RequestService.class, builder).downloadFile("bytes=" +
