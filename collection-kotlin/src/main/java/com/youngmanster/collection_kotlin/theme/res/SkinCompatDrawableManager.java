...
//            androidx.appcompat.R.drawable.abc_text_select_handle_right_mtrl_light
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context,
        ...
        if (resId == androidx.appcompat.R.drawable.abc_cab_background_top_material) {
            dr = new LayerDrawable(new Drawable[]{
                    getDrawable(context, androidx.appcompat.R.drawable.abc_cab_background_internal_bg),
                    getDrawable(context, androidx.appcompat.R.drawable.abc_cab_background_top_mtrl_alpha)
            });
        }
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int resId,
        ...
        if (tintList != null) {
            ...
            setPorterDuffColorFilter(ld.findDrawableByLayerId(android.R.id.background),
                    getThemeAttrColor(context, androidx.appcompat.R.attr.colorControlNormal), DEFAULT_MODE);
            ...
            setPorterDuffColorFilter(ld.findDrawableByLayerId(android.R.id.progress),
                    getThemeAttrColor(context, androidx.appcompat.R.attr.colorControlActivated), DEFAULT_MODE);
            ...
            LayerDrawable ld = (LayerDrawable) drawable;
            setPorterDuffColorFilter(ld.findDrawableByLayerId(android.R.id.background),
                    getDisabledThemeAttrColor(context, androidx.appcompat.R.attr.colorControlNormal),
                    DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(android.R.id.secondaryProgress),
                    getThemeAttrColor(context, androidx.appcompat.R.attr.colorControlActivated), DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(android.R.id.progress),
    ...
    static boolean tintDrawableUsingColorFilter(@NonNull Context context,
        ...
        } else if (resId == androidx.appcompat.R.drawable.abc_list_divider_mtrl_alpha) {
            colorAttr = android.R.attr.colorForeground;
            colorAttrSet = true;
            alpha = Math.round(0.16f * 255);
        } else if (resId == androidx.appcompat.R.drawable.abc_dialog_material_background) {
            colorAttr = android.R.attr.colorBackground;
            colorAttrSet = true;
        }
    ...
    ColorStateList getTintList(@NonNull Context context, @DrawableRes int resId) {
        ...
        if (tint == null) {
            ...
            if (resId == androidx.appcompat.R.drawable.abc_edit_text_material) {
                tint = SkinCompatResources.getColorStateList(context, androidx.appcompat.R.color.abc_tint_edittext);
            } else if (resId == androidx.appcompat.R.drawable.abc_switch_track_mtrl_alpha) {
                tint = SkinCompatResources.getColorStateList(context, androidx.appcompat.R.color.abc_tint_switch_track);
            ...
            } else if (resId == androidx.appcompat.R.drawable.abc_spinner_mtrl_am_alpha
                    || resId == androidx.appcompat.R.drawable.abc_spinner_textfield_background_material) {
                tint = SkinCompatResources.getColorStateList(context, androidx.appcompat.R.color.abc_tint_spinner);
            } else if (arrayContains(TINT_COLOR_CONTROL_NORMAL, resId)) {
                tint = getThemeAttrColorStateList(context, androidx.appcompat.R.attr.colorControlNormal);
            } else if (arrayContains(TINT_COLOR_CONTROL_STATE_LIST, resId)) {
                tint = SkinCompatResources.getColorStateList(context, androidx.appcompat.R.color.abc_tint_default);
            } else if (arrayContains(TINT_CHECKABLE_BUTTON_LIST, resId)) {
                tint = SkinCompatResources.getColorStateList(context, androidx.appcompat.R.color.abc_tint_btn_checkable);
            } else if (resId == androidx.appcompat.R.drawable.abc_seekbar_thumb_material) {
                tint = SkinCompatResources.getColorStateList(context, androidx.appcompat.R.color.abc_tint_seek_thumb);
            }
    ...
    private ColorStateList createDefaultButtonColorStateList(@NonNull Context context) {
        return createButtonColorStateList(context,
                getThemeAttrColor(context, androidx.appcompat.R.attr.colorButtonNormal));
    }
    ...
    private ColorStateList createColoredButtonColorStateList(@NonNull Context context) {
        return createButtonColorStateList(context,
                getThemeAttrColor(context, androidx.appcompat.R.attr.colorAccent));
    }
    ...
    private ColorStateList createButtonColorStateList(@NonNull final Context context,
        ...
        final int colorControlHighlight = getThemeAttrColor(context, androidx.appcompat.R.attr.colorControlHighlight);
        final int disabledColor = getDisabledThemeAttrColor(context, androidx.appcompat.R.attr.colorButtonNormal);
    ...
    private ColorStateList createSwitchThumbColorStateList(Context context) {
        ...
        if (thumbColor != null && thumbColor.isStateful()) {
            ...
            colors[i] = getThemeAttrColor(context, androidx.appcompat.R.attr.colorControlActivated);
            i++;
            ...
            // Disabled state
            states[i] = SkinCompatThemeUtils.DISABLED_STATE_SET;
            colors[i] = getDisabledThemeAttrColor(context, androidx.appcompat.R.attr.colorSwitchThumbNormal);
            i++;
            ...
            // Default enabled state
            states[i] = SkinCompatThemeUtils.EMPTY_STATE_SET;
            colors[i] = getThemeAttrColor(context, androidx.appcompat.R.attr.colorSwitchThumbNormal);
            i++;
        }
    ...
    private void checkVectorDrawableSetup(@NonNull Context context) {
        ...
        final Drawable d = getDrawable(context, androidx.appcompat.R.drawable.abc_vector_test);
