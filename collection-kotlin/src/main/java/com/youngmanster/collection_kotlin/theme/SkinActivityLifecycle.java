...
import com.youngmanster.collection_kotlin.theme.Inflater.SkinCompatDelegate;
import com.youngmanster.collection_kotlin.theme.annotation.Skinable;
...
import static com.youngmanster.collection_kotlin.theme.widget.SkinCompatHelper.checkResourceId;
...
public class SkinActivityLifecycle implements Application.ActivityLifecycleCallbacks {
    ...
    private SkinActivityLifecycle(Application application) {
        ...
        ThemeManager.getInstance().addObserver(getObserver(application));
    }
    ...
    public void onActivityResumed(Activity activity) {
        ...
        if (isContextSkinEnable(activity)) {
            ...
            ThemeManager.getInstance().addObserver(observer);
    ...
    public void onActivityDestroyed(Activity activity) {
        if (isContextSkinEnable(activity)) {
            ThemeManager.getInstance().deleteObserver(getObserver(activity));
    ...
    private void updateWindowBackground(Activity activity) {
        if (ThemeManager.getInstance().isSkinWindowBackgroundEnable()) {
    ...
    private boolean isContextSkinEnable(Context context) {
        return ThemeManager.getInstance().isSkinAllActivityEnable()
