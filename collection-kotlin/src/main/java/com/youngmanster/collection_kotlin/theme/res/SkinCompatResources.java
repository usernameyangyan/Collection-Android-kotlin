...
public class SkinCompatResources {
    ...
    private ThemeManager.SkinLoaderStrategy mStrategy;
    ...
    public void reset() {
        reset(ThemeManager.getInstance().getStrategies().get(ThemeManager.SKIN_LOADER_STRATEGY_NONE));
    }

    public void reset(ThemeManager.SkinLoaderStrategy strategy) {
        mResources = ThemeManager.getInstance().getContext().getResources();
        mSkinPkgName = "";
        mSkinName = "";
        mStrategy = strategy;
        isDefaultSkin = true;
    ...
    public void setupSkin(Resources resources, String pkgName, String skinName, ThemeManager.SkinLoaderStrategy strategy) {
    ...
    public ThemeManager.SkinLoaderStrategy getStrategy() {
        return mStrategy;
    }
    ...
    public int getColor(int resId) {
        return getColor(ThemeManager.getInstance().getContext(), resId);
    }

    @Deprecated
    public Drawable getDrawable(int resId) {
        return getDrawable(ThemeManager.getInstance().getContext(), resId);
    }

    @Deprecated
    public ColorStateList getColorStateList(int resId) {
        return getColorStateList(ThemeManager.getInstance().getContext(), resId);
    }
