...
import com.youngmanster.collection_kotlin.theme.utils.ImageUtils;
...
import static com.youngmanster.collection_kotlin.theme.res.ColorState.checkColorValid;
import static com.youngmanster.collection_kotlin.theme.res.ColorState.toJSONObject;
...
public class SkinCompatUserThemeManager {
    ...
    private void startLoadFromSharedPreferences() throws JSONException {
        String colors =DataManager.DataForSharePreferences.Companion.getObject(SkinConstants.KEY_SKIN_USER_THEME,"");
    ...
    public void apply() {
        ...
        DataManager.DataForSharePreferences.Companion.getObject(SkinConstants.KEY_SKIN_USER_THEME,jsonArray.toString());
        ThemeManager.getInstance().notifyUpdateSkin();
    }
    ...
    private String getEntryName(int resId, String entryType) {
        Context context = ThemeManager.getInstance().getContext();
